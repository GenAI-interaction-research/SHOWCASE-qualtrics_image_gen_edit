...
def create_app():
   ...
   credentials_path = "qualtricsinteraction-77b7cc96c128.json"
   storage_client = storage.Client.from_service_account_json(credentials_path)
   bucket = storage_client.bucket('qualtricsinteraction.appspot.com')
   ...
   def save_final_image():
       try:
           ...
           image_data = data['imageData'].split(',')[1]  # Remove data:image/jpeg;base64,
           image_bytes = base64.b64decode(image_data)
           prolific_id = data['prolificId']

           # Upload to GCS
           blob = bucket.blob(f'final_images/{prolific_id}.jpg')
